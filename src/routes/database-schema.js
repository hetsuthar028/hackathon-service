...
queries = {
    ...
    createWinnerTable: "CREATE TABLE IF NOT EXISTS winner(userEmail VARCHAR(50) NOT NULL, userName TEXT NOT NULL, hackathonID VARCHAR(50) NOT NULL, prize VARCHAR(20) NOT NULL, timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY(userEmail, hackathonID), FOREIGN KEY(hackathonID) REFERENCES hackathon(id) ON UPDATE CASCADE)",
